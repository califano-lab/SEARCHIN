...
db = GraphDatabase("http://localhost:7474/", username="preppi", password="preppi" )
...
u1.relationships.create("likes a lot", b1)
u1.relationships.create("likes", b2)
u2.relationships.create("likes", b1 , pappa="tanta")
